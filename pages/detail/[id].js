...
import { faArrowRotateRight, faArrowUpRightFromSquare, faShareNodes, faEllipsisVertical } from '@fortawesome/free-solid-svg-icons'
                ...
                <div className='col-span-5 mr-10 flex flex-col'>
                    <div className=' w-full h-full'>
                        <div className="card w-full bg-base-100 shadow-xl border-2 border-black">
                            <figure>
                                <img className='object-cover w-full' src="https://api.lorem.space/image/shoes?h=600" alt="Shoes" />
                            </figure>
                    ...
                    <div className='flex flex-col w-full border-2 border-black rounded-lg mt-5'>
                        <div tabindex="0" className="collapse collapse-arrow border border-base-300 bg-base-100 rounded-lg">
                        ...
                        <div className='w-full h-20'>
                            <div className='flex flex-row justify-between items-center'>
                                ...
                                <div className="btn-group">
                                    <button className="btn border-2 border-gray-400 gap-1 peer"><FontAwesomeIcon icon={faArrowRotateRight} /></button>
                                    <button className="btn border-2 border-gray-400 gap-1"><FontAwesomeIcon icon={faArrowUpRightFromSquare} /></button>
                                    <button className="btn border-2 border-gray-400 gap-1"><FontAwesomeIcon icon={faShareNodes} /></button>
                                    <button className="btn border-2 border-gray-400 gap-1"><FontAwesomeIcon icon={faEllipsisVertical} /></button>
                                </div>
                            </div>
